...
function ProductGallery({ media }) {
  ...
  return (
    <div
      className={`grid gap-4 overflow-x-scroll md:overflow-x-auto grid-flow-col md:grid-flow-row  md:p-0 md:overflow-x-auto md:grid-cols-2 w-screen md:w-full lg:col-span-2`}
    >
      {media.map((med, i) => {
        let extraProps = {};
